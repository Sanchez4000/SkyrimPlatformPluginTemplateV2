 ...
 *
 * Демонстрирует базовый паттерн создания фичи:
 * подписка на событие, покадровый счётчик, изменение игрового состояния.
 *
 * Скопируйте этот файл как основу для своей фичи,
 * затем удалите этот класс и его регистрацию из index.ts.
 */
